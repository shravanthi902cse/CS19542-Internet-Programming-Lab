...
include 'C:\xampp\htdocs\social_sync\includes\db.php'; // Include your database connection
...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data" class="mb-4">
        <div class="form-group">
            <label for="media">Select Media to Upload</label>
            <input type="file" name="media" class="form-control-file" id="media" required>
        </div>
        <div class="form-group">
            <label for="caption">Caption</label>
            <textarea name="caption" class="form-control" id="caption" rows="3" placeholder="Add a caption (optional)"></textarea>
        </div>
